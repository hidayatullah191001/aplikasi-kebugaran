<div class="page-wrapper">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?=base_url('admin') ?>">Home</a>
								<span>&nbsp > &nbsp</span>
								<a href="<?=base_url('admin/cabor') ?>"> <?=$title ?></a>
							</li>
						</ol>
					</nav>
				</div>
	...
	<div class="container-fluid">
		...
		<div class="row mt-3">
			<div class="col-md-6">
				<a href="<?= base_url();?>admin/tambah_cabor" class="btn btn-primary">Tambah Data Cabang Olahraga</a>
			</div>
		</div>
							...
							<tbody>
								...
								<?php foreach ($cabor as $dt) :?>
									<tr>
										...
										<td><?= $dt['nama_cabor'];?></td>
										<td>
											<a href="<?= base_url(); ?>admin/edit_cabor/<?= $dt['id']; ?>" class="btn btn-sm btn-success ">Ubah</a>
