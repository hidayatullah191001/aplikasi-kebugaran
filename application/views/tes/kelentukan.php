<div class="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="col">
			<form method="post" action="<?=base_url('kelentukan/uji/').$atlet['id'] ?>">
				<div class="row">
					<div class="col">
						<div class="card">
							<div class="card-header">
							...
							<div class="card-body">
								<div class="form-group row">
									<label class="col-sm-6 col-form-label">Sit and Reach</label>
									<div class="col-sm-6">
										<input type="text" name="tessit" value="<?=set_value('tessit') ?>" class="form-control" id="tessit">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-6 col-form-label">Standing Trunk Flexion</label>
									<div class="col-sm-6">
										<input type="text" name="tesstandingtrunk" value="<?=set_value('tesstandingtrunk') ?>" class="form-control" id="tesstandingtrunk">
									</div>
								</div>
								<div>
					...
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col">
										<input readonly="" type="text" class="form-control" id="hslsit" name="hslsit" value="<?=set_value('hslsit') ?>">
									</div>
								</div>
								<div class="form-group row">
									<div class="col">
										<input readonly="" type="text" class="form-control" id="hslstandingtrunk" name="hslstandingtrunk" value="<?=set_value('hslstandingtrunk') ?>">
									</div>
								</div>
							</div>
						</div>
					...
					<table class="table table-hover">
						<thead>
							<tr>
								...
								<th width="200">Sit and Reach</th>
								<th width="200">Standing Trunk Flexion</th>
							...
							<?php if ($count < 1): ?>
								...
								<?php else: ?>
									...
									<?php foreach ($kelentukan as $dt) : ?>
										...
										<td>
											<a href="<?=base_url('kelentukan/hapusdata/').$atlet['id'].'/'.$dt['id']?>" class="btn btn-sm btn-danger">Hapus</a>
										</td>
									</tr>
								<?php endforeach ?>
							<?php endif ?>
		...
		<script src="<?=base_url('assets/dist/js/data tes/kelentukan.js') ?>"></script>
		<script type="text/javascript">
			function bersih(){
				document.getElementById('tessit').value = '';
				document.getElementById('tesstandingtrunk').value = '';

				document.getElementById('hslsit').value = '';
				document.getElementById('hslstandingtrunk').value = '';
			}
		</script>