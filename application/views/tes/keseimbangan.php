<div class="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="col">
			<form method="post" action="<?=base_url('keseimbangan/uji/').$atlet['id'] ?>">
				<div class="row">
					<div class="col">
						<div class="card">
							<div class="card-header">
							...
							<div class="card-body">
								<div class="form-group row">
									<label class="col-sm-6 col-form-label">Stork Stand</label>
									<div class="col-sm-6">
										<input type="text" name="tesstork" value="<?=set_value('tesstork') ?>" class="form-control" id="tesstork">
									</div>
								</div>
								<div>
					...
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col">
										<input readonly="" type="text" class="form-control" id="hslstork" name="hslstork" value="<?=set_value('hslstork') ?>">
									</div>
								</div>
							</div>
						</div>
							...
							<?php if ($count < 1): ?>
								...
								<?php else: ?>
									...
									<?php foreach ($keseimbangan as $dt) : ?>
										...
										<td><?=$dt['storkstand']?></td>
										<td>
											<a href="<?=base_url('keseimbangan/hapusdata/').$atlet['id'].'/'.$dt['id']?>" class="btn btn-sm btn-danger">Hapus</a>
										</td>
									</tr>
								<?php endforeach ?>
							<?php endif ?>
		...
		<script src="<?=base_url('assets/dist/js/data tes/keseimbangan.js') ?>"></script>
		<script type="text/javascript">
			function bersih(){
				document.getElementById('tesstork').value = '';
				document.getElementById('hslstork').value = '';
			}
		</script>